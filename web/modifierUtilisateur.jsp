<%-- 
    ...
    Created on : 17 oct. 2020, 14:51:28
    Author     : HP
--%>
        ...
        <div class="container-fluid">
                        ...
                        <form  method="post" action="ModifierUtilisateur">
                            ...
                            <%
                                ...
                                ResultSet rst = stat1.executeQuery("select * from login where ID ='" + Un + "'");

                                while (rst.next()) {

                                    int id = rst.getInt("ID");
                                    String k = rst.getString("username");
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-lg" id="colFormLabelLg" name="ki" value= <%out.print(k);%>>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="colFormLabelLg" class="col-sm-2 col-form-label col-form-label-lg">Mot de passe</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-lg" id="colFormLabelLg"  name="pi" value= <%out.print(p);%>>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-lg" id="colFormLabelLg"  name="ri" value= <%out.print(r);%>>
                                </div>
                            </div>
                                   <% }%> 
                            <div class="form-group row">
