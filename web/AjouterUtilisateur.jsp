<%-- 
    Document   : FormulaireAjouter
    Created on : 17 oct. 2020, 23:13:50
    Author     : HP
--%>
   ...
   <div class="container-fluid">
                        ...
                        <form  method="post" action="AjouterUtilisateur">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-lg" id="colFormLabelLg" placeholder="Nom" name="name">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-lg" id="colFormLabelLg" placeholder="Mot de passe" name="password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-lg" id="colFormLabelLg" placeholder="Role" name="role">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-auto">
