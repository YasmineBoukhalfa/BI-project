...
public class AjouterUtilisateur extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       // processRequest(request, response);
        ...
        String sql ="insert into login (username, password, role) values ( '"+nam+"' ,'"+passwor+"' ,'"+rol+"')";
       //  ps.executeUpdate(sql);
           ...
           pst.executeUpdate(sql); 
              ...
              request.getRequestDispatcher("afficherUtilisateur.jsp").forward(request, response);
